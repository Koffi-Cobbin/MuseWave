              ...
              <div className="flex items-center gap-2 shrink-0">
                ...
                <Select value={trackSort} onValueChange={(v) => setTrackSort(v)}>
                  <SelectTrigger
                    ...
                    className="h-auto rounded-xl border-white/15 bg-white/10 px-3 py-2 text-xs text-white focus:ring-0 focus:border-white/30 w-auto gap-1.5"
                  >
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent className="rounded-xl border-white/15 bg-background/95 backdrop-blur-md">
