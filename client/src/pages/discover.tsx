        ...
        <header className="mb-6 flex items-center justify-between gap-3">
          <div className="flex min-w-0 items-center gap-2 sm:gap-3">
            ...
            <div className="flex min-w-0 items-center gap-2">
              <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border border-white/10 bg-gradient-to-br from-emerald-400/30 to-fuchsia-500/20">
                <Compass className="h-4 w-4 text-primary" />
              </div>
              <div className="min-w-0">
                <h1 className="text-lg font-black tracking-tight sm:text-xl" data-testid="text-discover-heading">
                  Discover
                </h1>
                <p className="truncate text-[10px] text-muted-foreground sm:text-xs">
                  {processed.length} tracks · {Object.keys(genreCounts).length} genres
                </p>
              </div>
            </div>
          </div>
